...
use Iliuminates\Http\Validations\Types\DataTypeValidation;
use Iliuminates\Http\Validations\Types\QueryValidations;
use Iliuminates\Logs\Log;

class Validation
{
    use DataTypeValidation, CheeckInArrayValidations, QueryValidations;
     ...
     * @return string
     */
    protected static function getMethodName($rule)
    {
        if (preg_match('/^in:/i', $rule)) {
            return 'in';
     ...
     * @return string
     */
    private static function attribute($attributes, $key)
    {
